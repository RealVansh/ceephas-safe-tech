...
<<<<<<< HEAD
          <div className="flex items-center gap-3 text-xs text-slate-400 font-medium">
            ...
            <a href="mailto:vanshv0920@gmail.com" className="hover:text-accent transition-colors" title="Email Vansh" aria-label="Email Vansh">
              <Mail className="w-3.5 h-3.5" />
            </a>
            <a href="tel:+917010526173" className="hover:text-accent transition-colors" title="Call Vansh" aria-label="Call Vansh">
